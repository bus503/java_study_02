	...
	public static void main(String[] args) {
		...
		*/
		...
		do {
			...
			String[] selectionValues = {"목록", "추가", "수정", "삭제", "검색", "학번순", "총점순", "종료"};
			String selRes = (String) JOptionPane.showInputDialog(
					null, 
					"선택하세요", 
					"학생관리", 
...
//		Student[] stds = new Student[listStudent.size()];
//		listStudent.toArray(stds);
